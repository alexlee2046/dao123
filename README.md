...
- ✅ **撤销/重做功能**
  ...
  - 支持快捷键操作
- ✅ **多页面支持 (New)**
  - AI 自动规划并生成多页面结构 (index.html, about.html 等)
  - 页面管理面板 (列表/新增/删除)
  - 页面间智能链接导航
...
```
为一个科技公司创建官网，包含以下页面：
1. 首页 (index.html): 展示核心产品和 Hero 区域
2. 关于我们 (about.html): 公司介绍和团队成员
3. 联系方式 (contact.html): 联系表单和地图
请确保页面之间可以通过导航栏互相跳转。
```
