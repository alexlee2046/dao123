                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                ...
                                <li><Link href="https://github.com/alexlee2046/dao123/blob/main/CHANGELOG.md" target="_blank" className="hover:text-foreground">{t('footer.changelog')}</Link></li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-border/40">
                        ...
                        <div className="flex gap-4">
                            <Button variant="ghost" size="icon" className="rounded-full" asChild>
                                <Link href="https://github.com/alexlee2046/dao123" target="_blank" rel="noopener noreferrer">
