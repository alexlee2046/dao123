...
export function PublishModal({ children, pageCount = 1 }: { children: React.ReactNode, pageCount?: number }) {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText(`https://${subdomain}.stitchclone.app`);
    };
                ...
                {step === 'config' && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Choose how you want to publish your site.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="grid gap-4 py-4">
                            <Button onClick={handlePublish} className="w-full">
                                <Globe className="mr-2 h-4 w-4" />
                                Publish to dao123 Subdomain
                            </Button>
                ...
                {step === 'deploying' && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                We are building and deploying your site to the edge.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="py-4">
                            <div className="flex items-center gap-2 p-3 bg-muted rounded-md">
                                ...
                                <span className="flex-1 text-sm font-medium truncate">
                                    https://{subdomain}.stitchclone.app
                                </span>
