...
import { Share, Play, Save, Globe, Loader2, FileCode } from "lucide-react";
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <PublishToCommunityModal>
                            <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full hover:bg-background hover:scale-105 transition-all duration-200">
