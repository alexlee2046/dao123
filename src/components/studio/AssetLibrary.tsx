    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[800px] h-[600px] flex flex-col">
                <DialogHeader>
                    <DialogTitle>{t('assetsManager.libraryTitle')}</DialogTitle>
                    <DialogDescription>
                        {t('assetsManager.libraryDesc')}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex items-center justify-between py-4">
                    <Tabs defaultValue="all" className="w-full">
                        <div className="flex items-center justify-between mb-4">
                            <TabsList>
                                <TabsTrigger value="all">{t('assetsManager.filterAll')}</TabsTrigger>
                                <TabsTrigger value="image">{t('assetsManager.filterImage')}</TabsTrigger>
                                <TabsTrigger value="video">{t('assetsManager.filterVideo')}</TabsTrigger>
                                <TabsTrigger value="font">{t('assetsManager.filterFont')}</TabsTrigger>
                            </TabsList>
                            <div>
                                <input
                                    type="file"
                                        ...
                                        <TabsContent key={tab} value={tab} className="mt-0">
                                            {assets.length === 0 && tab === 'all' ? (
                                                <div className="flex flex-col items-center justify-center h-[300px] text-muted-foreground">
                                                    ...
                                                    <Button variant="link" onClick={() => fileInputRef.current?.click()}>{t('assetsManager.uploadFirstAsset')}</Button>
                                                </div>
                                            ) : (
