...
export default function SignupPage() {
    ...
    const passwordLabels = {
        ...
        veryStrong: t('passwordStrength.veryStrong'),
    }
    ...
    const passwordRequirements = {
        ...
        hasSpecial: t('passwordRequirements.hasSpecial'),
    }
    ...
    return (
        <div className="w-full h-screen lg:grid lg:grid-cols-2 overflow-hidden">
            ...
            <div className="hidden lg:flex relative flex-col justify-between p-10 bg-zinc-900 text-white overflow-hidden">
                {/* Background Effects */}
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-purple-900/40 via-zinc-900 to-zinc-900 z-0"></div>
                <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2"></div>
                ...
                <motion.div
                    ...
                    className="absolute top-1/4 right-1/4 w-3 h-3 bg-emerald-400 rounded-full blur-[1px]"
                />
                <motion.div
                    animate={{
                        y: [0, 40, 0],
                    ...
                    className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-blue-400 rounded-full blur-[1px]"
                />
            ...
            <div className="flex items-center justify-center p-8 bg-background relative">
                ...
                <div className="mx-auto w-full max-w-[350px] space-y-8">
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        <Button className="w-full h-11 text-base shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all" type="submit" disabled={isAnyLoading || password.length < 8}>
                            {loading ? (
